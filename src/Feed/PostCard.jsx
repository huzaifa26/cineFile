...
export default function PostCard({post}) {
  ...
  return (
    <div className='px-[3.802vw]'>
      ...
      <p className='font-[400] text-[18px] leading-[24px] mb-[20px]'>{post.content}</p>
      ...
      <div className=''>
        ...
        <div className='bg-white py-[10px] px-[50px] flex justify-between items-center'>
          <div onClick={likeClickHandler} className='flex items-center gap-[12px] cursor-pointer hover:scale-[1.1] transition-all'>
            ...
            <p className='text-black font-[400] text-[24px] leading-[24px]'>Like<span className='pl-[5px] text-[18px]'>({post.likeCount})</span></p>
          </div>
          <div className='flex items-center gap-[12px]'>
            ...
            <p className='text-black font-[400] text-[24px] leading-[24px]'>Comment</p>
          </div>
          <div className='flex items-center gap-[12px]'>
            <svg width="50" height="50" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-black font-[400] text-[24px] leading-[24px]'>Share</p>
          </div>
        </div>
      </div>
    </div>
