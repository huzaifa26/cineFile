          ...
          <div className='flex xsm:w-full sm:w-full xsm:justify-between sm:justify-between gap-[5.41vw] xsm:gap-[1vw]'>
            <NavLink to={'/home'} className={({ isActive }) => isActive ? "text-[#002B73]" : "text-white"}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <p className='xsm:text-[14px] text-white text-[16px]'>Rating</p>
              </div>
            </NavLink>
            <NavLink to={'/friends'} className={({ isActive }) => isActive ? "text-[#002B73]" : "text-white"}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <p className='xsm:text-[14px] text-white text-[16px]'>Friends</p>
              </div>
            </NavLink>
            ...
            <NavLink to={'/file'} className={({ isActive }) => isActive ? "text-[#002B73]" : "text-white"}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <p className='xsm:text-[14px] text-white text-[16px]'>File</p>
              </div>
            </NavLink>
            <div className='flex flex-col items-center justify-center'>
              ...
              <p className='xsm:text-[14px] text-white text-[16px]'>Theaters</p>
            </div>
            <div className='flex flex-col items-center justify-center '>
              ...
              <p className='xsm:text-[14px] text-white text-[16px]'>Inbox</p>
            </div>
            <NavLink to={'/feed'} className={({ isActive }) => isActive ? "text-[#002B73]" : "text-white"}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <p className='xsm:text-[14px] text-white text-[16px]'>Feed</p>
              </div>
            </NavLink>
